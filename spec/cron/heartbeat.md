...
Check `memory/tasks/heartbeat.md` for pending work. If the file doesn't exist, there's nothing to do — reply with exactly NO_REPLY (no backticks or quotes).
...
If nothing was completed and nothing noteworthy happened, reply with exactly NO_REPLY (no backticks or quotes).
